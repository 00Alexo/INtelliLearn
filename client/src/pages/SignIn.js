...
const SignIn = () => {
    ...
    const onSubmit = async(e) => {
        e.preventDefault();
        try {
            const response = await fetch('https://intellilearn.onrender.com/user/login', {
                method: 'POST',
                headers: {
    ...
    return (
        ...
        <form className='signUp-div signindiv'>
            ...
            <div className='login-icons'>
                <svg style={{margin:'0 auto'}} cursor="pointer" viewBox="0 -28.5 256 256" width="55" height="55" version="1.1" preserveAspectRatio="xMidYMid" fill="#000000">
            ...
            <div className='submit-div'>
                ...
                <p className='signText'>
                    Not registered? <Link to="/signup" className="change-toInUp"> Sign-Up </Link> 
                </p>
            </div>    
        </form>
    </div>
